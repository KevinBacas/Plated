export type TargetType = 'department' | 'country';
...
const departments: DepartmentSeed[] = [
  ...
  ['58', 'Nièvre', 'Bourgogne-Franche-Comté'], ['59', 'Nord', 'Hauts-de-France'], ['60', 'Oise', 'Hauts-de-France'],
  ['61', 'Orne', 'Normandie'], ['62', 'Pas-de-Calais', 'Hauts-de-France'], ['63', 'Puy-de-Dôme', 'Auvergne-Rhône-Alpes'],
  ['64', 'Pyrénées-Atlantiques', 'Nouvelle-Aquitaine'], ['65', 'Hautes-Pyrénées', 'Occitanie'], ['66', 'Pyrénées-Orientales', 'Occitanie'],
  ['67', 'Bas-Rhin', 'Grand Est'], ['68', 'Haut-Rhin', 'Grand Est'], ['69', 'Rhône', 'Auvergne-Rhône-Alpes'],
  ['70', 'Haute-Saône', 'Bourgogne-Franche-Comté'], ['71', 'Saône-et-Loire', 'Bourgogne-Franche-Comté'], ['72', 'Sarthe', 'Pays de la Loire'],
  ['73', 'Savoie', 'Auvergne-Rhône-Alpes'], ['74', 'Haute-Savoie', 'Auvergne-Rhône-Alpes'], ['75', 'Paris', 'Île-de-France'],
  ['76', 'Seine-Maritime', 'Normandie'], ['77', 'Seine-et-Marne', 'Île-de-France'], ['78', 'Yvelines', 'Île-de-France'],
  ['79', 'Deux-Sèvres', 'Nouvelle-Aquitaine'], ['80', 'Somme', 'Hauts-de-France'], ['81', 'Tarn', 'Occitanie'],
  ['82', 'Tarn-et-Garonne', 'Occitanie'], ['83', 'Var', "Provence-Alpes-Côte d'Azur"], ['84', 'Vaucluse', "Provence-Alpes-Côte d'Azur"],
  ['85', 'Vendée', 'Pays de la Loire'], ['86', 'Vienne', 'Nouvelle-Aquitaine'], ['87', 'Haute-Vienne', 'Nouvelle-Aquitaine'],
  ['88', 'Vosges', 'Grand Est'], ['89', 'Yonne', 'Bourgogne-Franche-Comté'], ['90', 'Territoire de Belfort', 'Bourgogne-Franche-Comté'],
  ['91', 'Essonne', 'Île-de-France'], ['92', 'Hauts-de-Seine', 'Île-de-France'], ['93', 'Seine-Saint-Denis', 'Île-de-France'],
  ['94', 'Val-de-Marne', 'Île-de-France'], ['95', "Val-d'Oise", 'Île-de-France'], ['971', 'Guadeloupe', 'Guadeloupe'],
  ['972', 'Martinique', 'Martinique'], ['973', 'Guyane', 'Guyane'], ['974', 'La Réunion', 'La Réunion'], ['976', 'Mayotte', 'Mayotte'],
];

export const DEPARTMENTS: Target[] = departments.map(([code, name, region]) => ({
  id: `department-${code}`,
  type: 'department',
  code,
  name,
...
const countries: [string, string, string, string][] = [
  ['AT', 'Autriche', 'A', '🇦🇹'], ['BE', 'Belgique', 'B', '🇧🇪'], ['BG', 'Bulgarie', 'BG', '🇧🇬'],
  ['HR', 'Croatie', 'HR', '🇭🇷'], ['CY', 'Chypre', 'CY', '🇨🇾'], ['CZ', 'Tchéquie', 'CZ', '🇨🇿'],
  ['DK', 'Danemark', 'DK', '🇩🇰'], ['EE', 'Estonie', 'EST', '🇪🇪'], ['FI', 'Finlande', 'FIN', '🇫🇮'],
  ['DE', 'Allemagne', 'D', '🇩🇪'], ['GR', 'Grèce', 'GR', '🇬🇷'], ['HU', 'Hongrie', 'H', '🇭🇺'],
  ['IE', 'Irlande', 'IRL', '🇮🇪'], ['IT', 'Italie', 'I', '🇮🇹'], ['LV', 'Lettonie', 'LV', '🇱🇻'],
  ['LT', 'Lituanie', 'LT', '🇱🇹'], ['LU', 'Luxembourg', 'L', '🇱🇺'], ['MT', 'Malte', 'M', '🇲🇹'],
  ['NL', 'Pays-Bas', 'NL', '🇳🇱'], ['PL', 'Pologne', 'PL', '🇵🇱'], ['PT', 'Portugal', 'P', '🇵🇹'],
  ['RO', 'Roumanie', 'RO', '🇷🇴'], ['SK', 'Slovaquie', 'SK', '🇸🇰'], ['SI', 'Slovénie', 'SLO', '🇸🇮'],
